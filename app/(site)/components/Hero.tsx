    ...
    <section id="intro" className="pt-32 pb-20 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h1 className="text-5xl md:text-6xl font-bold mb-8 leading-tight">
          Create Content That
          <br />
          <span className="bg-[linear-gradient(90deg,rgba(var(--brand-600),1),rgba(var(--brand-700),1))] bg-clip-text text-transparent">
            Shapes Web3
          </span>
        </h1>
        ...
        <div className="flex items-center justify-center gap-4">
          <a href="#metrics" className="rounded-full px-6 py-3 text-white bg-[color:rgb(var(--brand-700))] hover:bg-[color:rgb(var(--brand-600))]">
            Explore Resources
          </a>
          <a href="#" className="rounded-full px-6 py-3 border border-black/10 hover:border-black/20">
            View Documentation
          </a>
        </div>
      </div>
